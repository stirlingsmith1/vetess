        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-base leading-7 text-[#5f5f5f] md:text-lg">
              ...
              support, better job preparation, and opportunities that actually
              make sense for you.
            </p>
          </div>
          ...
          <div className="mb-16 grid gap-6 md:grid-cols-3">
            <article className="rounded-3xl border border-[#e7dfd4] bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-6 text-[#555]">
                Moving out of the military can feel like a lot. This helps you
                understand what comes next and how to navigate it without
                feeling lost.
              </p>
            </article>
            ...
            <article className="rounded-3xl border border-[#e7dfd4] bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-6 text-[#555]">
                Get your resume right, understand what employers are looking
                for, and feel more confident going into interviews.
              </p>
            </article>
            ...
            <article className="rounded-3xl border border-[#e7dfd4] bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-6 text-[#555]">
                ...
                something long-term that actually works for your life.
              </p>
            </article>
          </div>
          ...
          <div className="mb-16 rounded-3xl border border-[#e7dfd4] bg-white p-6 shadow-sm md:p-10">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-2xl bg-[#fcfbf8] p-5">
                ...
                <p className="text-sm leading-6 text-[#555]">
                  Start with your goals and what kind of support you’re looking
                  for.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-[#fcfbf8] p-5">
                ...
                <p className="text-sm leading-6 text-[#555]">
                  Look through opportunities and resources that actually fit
                  your background.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-[#fcfbf8] p-5">
                ...
                <p className="text-sm leading-6 text-[#555]">
                  Move forward with more direction and confidence in what you’re
                  doing.
                </p>
              </div>
            </div>
          ...
          {/* CTA section */}
          <div className="mb-16 rounded-3xl border border-[#e7dfd4] bg-white p-8 text-center shadow-sm md:p-10">
            ...
            <p className="mx-auto mb-6 max-w-2xl text-sm leading-6 text-[#555] md:text-base">
              Check out available opportunities and start figuring out what your
      ...
      <section className="bg-[#f7f4ef] px-4 py-16 md:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            ...
            <h2 className="mb-4 text-4xl font-bold tracking-tight text-[#1f2f6b] md:text-6xl">
              Start Your Next Step with Vetess
            </h2>

            <p className="mx-auto mb-8 max-w-2xl text-sm leading-7 text-[#5f5f5f] md:text-base">
              Share a few details to help us understand your goals and what kind
              of support you need.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <article className="rounded-[1.25rem] border border-[#e4d8c4] bg-white p-6 shadow-sm">
                ...
                <p className="mb-6 text-sm leading-7 text-[#555]">
                  Browse open roles and see what opportunities line up with your
                  goals, experience, and next move.
                </p>
              ...
              <article className="rounded-[1.25rem] border border-[#e4d8c4] bg-white p-6 shadow-sm">
                ...
                <p className="mb-6 text-sm leading-7 text-[#555]">
                  Help support the work being done to connect veterans with
                  better opportunities, guidance, and resources.
                </p>
